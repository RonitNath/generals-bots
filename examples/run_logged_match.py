...
parser.add_argument("--agent-a", type=str, default="material", choices=sorted(BUILTIN_AGENTS))
parser.add_argument("--agent-b", type=str, default="backdoor", choices=sorted(BUILTIN_AGENTS))
